...
const NotificationCenter = () => {
    ...
    useEffect(() => {
        ...
        // Poll every 30 seconds for new "Live" feeling
    ...
    const fetchNotifications = async () => {
        try {
            ...
            if (res.data && Array.isArray(res.data)) {
                ...
                // Assume all are unread for demo
    ...
    return (
        <div className="notification-center" ref={dropdownRef}>
            <button className="btn-bell" onClick={toggleOpen}>
            ...
            {isOpen && (
                <div className="notification-dropdown">
                    <div className="dropdown-header">
                        <h3>Thông báo</h3>
                        <span className="mark-read">Đánh dấu tất cả là đã đọc</span>
                    </div>
                ...
                <header className="sale-header">
                    <h1 className="page-title">
                        {(() => {
                            ...
                            // Check orders submenu items
                            const currentSubItem = ordersSubMenu.find(item => item.path === location.pathname);
                            ...
                            if (location.pathname.startsWith('/sale/orders/')) {
                                return t('orders.orderDetail') || 'Chi tiết đơn hàng';
                            }
