...
const SaleDashboard = () => {
    ...
    return (
        <div className="sale-dashboard">
            ...
            {/* Quick Links */}
            <div className="quick-links" style={{ display: 'flex', gap: '15px', marginBottom: '25px' }}>
                <Link to="/sale/new-order" style={{
                    flex: 1, padding: '20px', background: '#3498db', color: 'white',
                    borderRadius: '10px', textDecoration: 'none', textAlign: 'center', fontSize: '18px', fontWeight: 'bold'
                }}>
                    ➕ {t('sale.createOrder')}
                </Link>
                <Link to="/sale/stock" style={{
                    flex: 1, padding: '20px', background: '#2ecc71', color: 'white',
                    borderRadius: '10px', textDecoration: 'none', textAlign: 'center', fontSize: '18px', fontWeight: 'bold'
                }}>
                    📦 {t('sale.stockLookup') || 'Check Stock'}
                </Link>
                <Link to="/sale/returns" style={{
                    flex: 1, padding: '20px', background: '#e67e22', color: 'white',
                    borderRadius: '10px', textDecoration: 'none', textAlign: 'center', fontSize: '18px', fontWeight: 'bold'
                }}>
                    ↩️ {t('sale.returns') || 'Process Returns'}
                </Link>
            </div>
