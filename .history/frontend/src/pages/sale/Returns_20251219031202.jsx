...
const SaleReturns = () => {
    ...
    <thead>
        <tr>
            ...
            {/* Căn phải số tiền */}
            <th style={{ textAlign: 'right' }}>{t('sale.total')}</th> 
            {/* Căn phải hành động */}
        ...
        {orders.map(o => (
            <tr key={o.id}>
                ...
                <td style={{ textAlign: 'center' }}>
                    <span style={{ fontWeight: 'bold', color: '#666', background: '#f8f9fa', padding: '4px 8px', borderRadius: '4px' }}>
                        #{o.id}
                    </span>
                </td>
                
                <td>
                    <div style={{fontWeight: 500}}>{o.customer_name || o.phone || 'Guest'}</div>
                    {o.phone && o.customer_name && <div style={{fontSize: '12px', color: '#888'}}>{o.phone}</div>}
                </td>
                ...
                <td style={{ textAlign: 'right' }}>
                    <button onClick={() => selectOrder(o)} className="btn-select">
                        {/* Sửa lỗi hiển thị common.select */}
