    ...
    return (
        <div className="admin-page">
            ...
            <div className="content-card">
                <div className="table-actions" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                    ...
                    <button className="btn-secondary" onClick={fetchTransfers} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        Refresh
                    </button>
                </div>
