...
const AdminDashboard = () => {
    ...
    return (
        <div className="dashboard-container">
            {/* HEADER ROW - Đã sửa để đẩy nút sang phải */}
            ...
            <div className="stats-grid-5">
                <div className="stat-card revenue clickable" onClick={() => navigate('/admin/reports')}>
                    ...
                    <p className="stat-change positive">↑ 12.5% <span style={{fontWeight:400, color:'#94a3b8', fontSize:'11px'}}>vs kỳ trước</span></p>
                </div>
                ...
                <div className="stat-card alerts clickable" onClick={() => navigate('/admin/inventory')}>
                    ...
                    <p style={{color:'#e74c3c', fontSize:'11px', marginTop:'5px', fontWeight:700}}>Cần kiểm tra kho</p>
                </div>
            </div>
